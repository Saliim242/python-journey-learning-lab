# in this file, we will learn about builtin methods in python
# builtin methods are methods that are available in python by default
# they are part of the python standard library and do not require any additional installation
# builtin methods are available for all objects in python
# they are used to perform common operations on objects
